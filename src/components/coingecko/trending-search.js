...
import useTrendingSearchTable from "src/hooks/coingecko/useTrendingSearchTable";
import { SeverityPill } from "../severity-pill";
import getColorRank from "src/utils/get-color-rank";
import useTime from "src/hooks/useTime";

export const TrendingSearch = (props) => {
  const { data, isLoading } = useTrendingSearchTable();
